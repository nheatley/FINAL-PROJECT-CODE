...
<body>
	...
	<section id="accountNav">
		<ul class="nav justify-content-center">
			...
			<li class="nav-item">
				<a class="nav-link" href="savedWorkouts.php"><font color="white">Saved Workouts</font></a>
			</li>
		</ul>
	</section>
	<div style="padding-top:20px">
		<h2 align="center">Remove Trainer</h2>
	</div><?php
	...
	$userID = htmlentities($_GET['userID']);
	 ...
	 $resultB = $conn->query("SELECT * FROM TrainerPal_User WHERE userID = '$userID'");
	  ...
	  //MULTIPLIES VALUE TO ORIGINAL VALUE
	  $userID = ($userID*$_SESSION['random']);  
	  ...
	  $userID= base64_encode($userID);
	      ...
	      echo "
	      <font color = 'red'><h3 align = 'center'> Are you sure you wish to remove $firstName as your Trainer? </h3></font>
	       <div align ='center' style = 'padding-bottom:10px;'>
	 <a class='btn btn-warning' href='trainingHome.php' role='button'>No, I do not</a>
	 </div>
	     <div align ='center' style = 'padding-bottom:10px;'>
	 <a class='btn btn-info' href='processRemoveTrainer.php?userID=$userID' role='button'>Yes, I am sure.</a>
	 </div>
	      ";
	}
	?>

...
<body>
	...
	<h4 align='center'>Send a Trainer Request to $firstName</h4>
	</div>
	      <div class = 'col-12'>
	                  <div align = 'center'>
	...
	<div class = 'col-12' style = 'margin:auto; text-align:center; padding-top:30px; padding-bottom:20px;'>
	       <form class='subform' id='sendMessageForm' action='processRequestTrainer.php?userID=$userID' method='POST'>
	                    <h6> Send a message with information on your goals along with your Trainer Request </h6>
	               ...
	               <input class='button btn-success u-full-width' id='requestTrainerSub' name='requestTrainerSubButton' type='submit' value='Request Trainer'>
	            </form>
	            </div>
	            </div>";

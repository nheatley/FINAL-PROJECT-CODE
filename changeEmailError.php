...
<body>
	...
	</header><!---CHANGE EMAIL FORM--->
      
       <div id = "regDiv" class = "col-8">
            <h3 id = "loginTitle">Change Email Address</h3>
            <font color = 'red'><h6 id = "loginTitle">You have entered incorrect credentials! Please try again.</h6> </font>
            <!== SIGN UP FORM -->
	<form action="processChangeEmail.php" class="loginForm" method="post">
		<div class="form-group">
			<input class="form-control" id='email' maxlength='50' name='email' placeholder="Email" required="" type="text">
		</div>
		<div class="form-group">
			<input class="form-control" id='password' maxlength='50' name='password' placeholder="Password" required="" type="password">
		</div><!-- SUBMISSION BUTTON FOR THIS FORM -->
		<input class="button btn-primary u-full-width" id="changeEmail" name='changeEmail' type="submit" value="Change Email">
            </form>
        </div>       

...
<body>
	...
	<div class="col-8" id="regDiv">
		<h2 id="signUpTitle">Your have successfully registered as a TrainerPal Trainer!</h2>
		<h5 id="signUpTitle">As a security measure you have been logged out. Please Login via the Trainer Portal<br>
		From the team at TrainerPal - we thank you for your co-operation.</h5>
		<p><a class="btn btn-primary" href="trainerLogin.php">Trainer Login</a></p>
	</div><!--- Footer Section =-->

...
<body>
	...
	<section id="accountNav">
		<ul class="nav justify-content-center">
			...
			<li class="nav-item">
				<a class="nav-link" href="#"><font color="white">Invoices</font></a>
			</li>
		</ul>
	</section>
	<div style="padding-top:20px">
	  ...
	  "
	<h4 align='center'><font color = 'green'>$firstName, you have accepted this new client!</h4></font>
	<p align='center'><a href='clientRequests.php' class='btn btn-success'>Back to Client Requests</a></p>
	<p align='center'><a href='clientManagerHome.php' class='btn btn-primary'>Back to Client Manager</a></p>
	            </div>";

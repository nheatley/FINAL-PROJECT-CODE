...
<body>
	...
	<div style="padding-top:20px">
		<h2 align="center"><font color='green'>This Exercise has been added. Thank you.</font></h2>
		<div align='center' style='padding-bottom:10px'>
			<a class="btn btn-primary" href="adminHome.php" role="button">Admin Home</a>
		</div>
		<div align='center' style='padding-bottom:10px'>
			<a class="btn btn-warning" href="insertExercise.php" role="button">Add another Exercise</a>
		</div>
	</div><!--- Footer Section =-->

...
<body>
	...
	<div align='center' style="padding-top:20px">
		<h2>Your Verification Request has been sent!</h2>
		<h4>Please await a response from our Admins, thank you.</h4>
	</div>
	<div align='center' style='padding-top:10px'>
		<a class='btn btn-primary' href='trainerAccount.php'>Back to Trainer Account</a> <!--- Footer Section =-->

...
<body>
	...
	<div style="padding-top:20px">
	  ...
	  "
	      <div class = 'col-12' style ='border-bottom: gray 3px solid;'>
	          ...
	          <font color = 'green'> <h4 align = 'center'>Paid Invoices. </h4></font>
	      </div>";         
	}
	?><?php
	...
	FROM TrainerPal_User INNER JOIN TrainerPal_Invoices ON TrainerPal_User.userID = TrainerPal_Invoices.client WHERE TrainerPal_Invoices.owner = '$activeID' AND TrainerPal_Invoices.paid = '2' ORDER BY TrainerPal_Invoices.invoiceID DESC");

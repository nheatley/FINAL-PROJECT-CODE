						...
						<?php if(isset($_SESSION['loggedSession'])) {
						            ...
						            // QUERY TO SEARCH IF USER IS OF ADMIN USER TYPE
						               $selectQuery = "SELECT * FROM TrainerPal_Admins where userID = '$activeID'";
						                ...
						                // AND NAV LINK TO ADMIN AREA APPEARS
						                $num = $result -> num_rows;
...
?>
	...
	<div align = 'center' style="padding-top:20px">
		<h2><font color = 'red'>404 ERROR!</font></h2>
		<h3> <font color = 'red'>The page you are looking for does not exist. </font> </h3>
		<h4> But do not worry, you can go back to the Home Page by clicking the button below. </h4>

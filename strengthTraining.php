...
<body>
	...
	<div style="padding-top:20px">
		<h2 align="center">Strength Training Exercises</h2>
		<h5 align="center">Here are some key compound movements for strength Building.</h5>
	</div><?php

	$selectQuery = "SELECT * FROM TrainerPal_Exercises WHERE workoutType = '5'";

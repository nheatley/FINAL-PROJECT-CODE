	  ...
	  "
	      <div class = 'col-12' style ='border-bottom: gray 3px solid;'>
	        <div align = 'center'>
	          ...
	          <font color = 'red'> <h4 align = 'center'>Below is a record of your Outstanding Invoices.</h4></font>
	      </div>";         
	}
	?><?php

	// QUERY TO GENERATE ALL THE CORRECT INFORMATION FOR THE INVOICE
	$resultB = $conn->query("SELECT TrainerPal_User.firstName, TrainerPal_User.lastName, TrainerPal_User.telephoneNumber, 
	                         TrainerPal_User.email, TrainerPal_User.city, TrainerPal_User.address, 
	                         TrainerPal_User.postcode, TrainerPal_User.country, TrainerPal_Invoices.invoiceTitle, 
	                         TrainerPal_Invoices.invoiceDescription, TrainerPal_Invoices.invoiceDate, TrainerPal_Invoices.invoiceAmount,
	                         TrainerPal_Invoices.client, TrainerPal_Invoices.paid, TrainerPal_Invoices.invoiceID
	                         FROM TrainerPal_User INNER JOIN TrainerPal_Invoices ON 
	                         TrainerPal_User.userID = TrainerPal_Invoices.owner WHERE 
	                         TrainerPal_Invoices.client = '$activeID' AND 
	                         TrainerPal_Invoices.paid = '1' ORDER BY TrainerPal_Invoices.invoiceID DESC");
	 ...
	 ";
	  ...
	  echo "
	      ...
	      <td>$firstName</td>
	      <td>£$invoiceAmount</td>
	      <td><a class='btn btn-primary' href='clientViewInvoice.php?invoiceID=$invoiceID' role='button'>More</a></td> 
	         </tr>
	  ";

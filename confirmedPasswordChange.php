...
<body>
	...
	<div class="col-8" id="regDiv">
		<h2 id="signUpTitle">Your Password has been changed successfully!</h2>
		<h5 id="signUpTitle">As a security measure you have been logged out. Please Login again with your new password.<br>

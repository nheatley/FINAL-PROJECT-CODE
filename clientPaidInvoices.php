...
<body>
	  ...
	  "
	      <div class = 'col-12' style ='border-bottom: gray 3px solid;'>
	       <div align = 'center'>
	          ...
	          <font color = 'green'> <h4 align = 'center'>Below is a record of your Paid Invoices.</h4></font>
	      </div>";         
	}
	?><?php
	...
	FROM TrainerPal_User INNER JOIN TrainerPal_Invoices ON TrainerPal_User.userID = TrainerPal_Invoices.owner WHERE TrainerPal_Invoices.client = '$activeID' AND TrainerPal_Invoices.paid = '2' ORDER BY TrainerPal_Invoices.invoiceID DESC");
	 ...
	 <font color = 'red'> <h2 align='center'>You have no paid invoices at the moment!</h2></font>
	 </div>";
	 } else {
	 echo "
	 <table class='table table-hover'>
	  ...
	  <tbody style = 'background-color:#C8FCD4'>
	    <tr>
	 ";
	 }

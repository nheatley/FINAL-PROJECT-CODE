...
<body>
	...
	<div style="padding-top:20px">
		<h2 align="center">Admin Messenger Home</h2>
	</div>
	<div class='container-fluid padding'>
		<div class='row padding'>
			<?php 
			  ...
			  "
			       <div class = 'col-12' style ='border-bottom: gray 3px solid;'>
			          ...
			          <img style = 'max-width: 250px' src='uploadedfiles/$profileImage' class='rounded-circle'>
			           ...
			           <h2 align='center'>Welcome $firstName!</h2>
			          <h4 align = 'center'> Manage Admin messages. </h4>
			          </div>
			      ";          
			}
			  ?><?php 
			 ...
			 <font color = 'red'><h2 align='center'>There are no messages at the moment!</h2></font>
			 ";
			 }
			    ...
			    <div class ='card' style = 'border-bottom: gray 3px solid; border-top: blue 2px solid; padding-top:8px;'>
			       ...
			       echo "
			        <p><a href='adminRespond.php?adminMessageID=$adminMessageID' class='btn btn-success'>Respond to $firstName</a></p>";
			              ...
			              echo "
			        <h5>This message been responded to </h5>";
			        
			    //QUERY TO SEE WHO RESPONDED TO THE MESSAGE 
			    $resultCheck = $conn->query ($respondCheck = "SELECT TrainerPal_User.firstName, TrainerPal_User.lastName, TrainerPal_User.userID
			  ...
			  echo "<p>by: $firstName $lastName</p>";

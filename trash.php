...
<body>
	...
	<div style="padding-top:20px; border-bottom:gray 3px solid;">
		<h2 align="center">Message Trash</h2>
	</div><?php 
	...
	if ($num == 0) {  
	 echo " <font color = 'red'> <h2 align='center'>You have no messages in the Trash!</h2></font>
	 ...
	 <a class='btn btn-primary' href='messengerHome.php' role='button'>Back to Messages</a>
	  ...
	  // <div class='media col-xs-12 col-md-8 col-lg-4' style = 'padding-top:20px; border-bottom: gray 2px solid;'>
	   echo 
	   "
	  ...
	  <div class='media-body' style = 'padding-bottom:10px'>
	    ...
	    <h4>$subject</h4>
	     <a class='btn btn-warning' href='viewTrashedMessage.php?messageID=$messageID' role='button'>Read</a>
	  </div>
	</div>";    

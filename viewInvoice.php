...
FROM TrainerPal_User INNER JOIN TrainerPal_Invoices ON TrainerPal_User.userID = TrainerPal_Invoices.client INNER JOIN TrainerPal_Trainer ON TrainerPal_Invoices.owner=TrainerPal_Trainer.userID WHERE TrainerPal_Invoices.invoiceID = '$invoiceID' ORDER BY TrainerPal_Invoices.invoiceID DESC");
 ...
 $query = $conn->query( "SELECT * FROM TrainerPal_User WHERE userID = '$activeID'");
...
FROM TrainerPal_User INNER JOIN TrainerPal_Invoices ON TrainerPal_User.userID = TrainerPal_Invoices.client INNER JOIN TrainerPal_Trainer ON TrainerPal_Invoices.owner=TrainerPal_Trainer.userID WHERE TrainerPal_Invoices.invoiceID = '$invoiceID' ORDER BY TrainerPal_Invoices.invoiceID DESC");
 ...
 $queryCheck = $conn->query( "SELECT * FROM TrainerPal_Invoices WHERE invoiceID= '$invoiceID' AND paid = '2'");
 
   if(!$queryCheck) {
    echo "did not work";
    }
  $num = $queryCheck -> num_rows;
  ...
  <a class='btn btn-success' href='markInvoicePaid.php?invoiceID=$invoiceID' role='button'>Mark as Paid</a>
    <a class='btn btn-warning' href='deleteInvoice.php?invoiceID=$invoiceID' role='button'>Delete Invoice</a>
  </div>
  ";
  }

...
<body>
	...
	<a class='btn btn-success btn-lg' href='processSendWorkout.php' name = 'noButton' role='button'><font color = 'white'>Yes, this is the one</font></a>
	         </div>
	<div align = 'center' style = 'padding-top:10px'>
	<a class='btn btn-warning btn-lg' href='sendWorkoutPlan.php' name = 'noButton' role='button'>No, this is wrong.</a>
	         </div> ";


	} else {
	//$userID = htmlentities($_GET['userID']);
	header('Location: sendWorkoutPlanYoutubeError.php');
	}
	?><!--- Footer Section =-->

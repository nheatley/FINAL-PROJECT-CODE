...
<body>
	...
	<div align='center' style="padding-top:20px">
		...
		<h3><font color='red'>This area is for Admin users only!</font></h3>
		<h3><font color='red'>Please click the button below to be redirected to the Home page.</font></h3><a class='btn btn-primary' href='index.php'>Home</a>
	</div><!--- Footer Section =-->

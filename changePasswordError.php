...
<body>
	...
	<header id="navHeader">
       ...
       <div id = "regDiv" class = "col-8">
            <h3 id = "loginTitle">Change Password</h3>
            <font color = 'red'> <h6 id = "loginTitle">The old password you have entered is wrong! Please try again.</h6> </font>
            <!== SIGN UP FORM -->
	<form action="processChangePassword.php" class="loginForm" method="post">
		<div class="form-group">
			<input class="form-control" id='oldPassw' maxlength='50' name='oldPassw' placeholder="Old Password" required="" type="password">
		</div><!-- SUBMISSION BUTTON FOR THIS FORM -->
		<input class="button btn-primary u-full-width" id="changePassword" name='changePasswButton' type="submit" value="Change Password">
	</form><!--- Footer Section =-->
	</div>

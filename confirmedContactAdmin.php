...
<body>
	...
	<h3 align='center'>Your message has been sent to the Admins,thank you.</h3>
	<div align='center' style='padding-top:10px'>
		<a class="btn btn-primary btn-lg" href="messengerHome.php" role="button">Back to Messenger</a>
	</div><!--- Footer Section =-->

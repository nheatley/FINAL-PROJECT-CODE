...
<body>
	...
	<div style="padding-top:20px">
		<h2 align="center">Cancel Trainer Request</h2>
		<h5 align="center">Are you sure you with to cancel this request?</h5>
	</div><?php
	    ...
	    <a class='btn btn-warning' href='processCancelRequest.php?trainerRequestID=$trainerRequestID' role='button'>Yes, I am sure.</a>
	    </div>
	    <div align = 'center' style = 'padding-top:10px; padding-bottom:10px;'>
	    <a class='btn btn-info' href='clientTrainerRequests.php' role='button'>No, I do not.</a>
	    </div>";

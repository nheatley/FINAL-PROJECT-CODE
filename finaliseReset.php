...
<body>
	...
	<div class="col-8" id="regDiv">
		<h3 id="signUpTitle">Reset Password</h3><!-- SIGN UP FORM -->
		<form action="insertResetPassword.php" class="signUpForm" method="post">
			...
			<input class="button btn-primary u-full-width" id="resetPassword" name='passwordReset' type="submit" value="Reset Password">
		</form>
	</div><!--- Footer Section =-->

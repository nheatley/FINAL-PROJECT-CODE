...
<body>
	...
	<div align='center' style='padding-top:10px'>
		<h2>Thank you for visiting TrainerPal: Health and Fitness.</h2>
		<h3>At the moment we currently only run on <font color='blue'>Google Chrome (version 70 and later)</font> and <font color='blue'>Apple Safari (version 10 and later)</font> Browsers.</h3>
		<h3>If you do not have Google Chrome and would like to download the browser,<br>
		just click <a href="https://www.google.co.uk/chrome/?brand=CHBD&gclid=Cj0KCQjwpPHoBRC3ARIsALfx-_KlXFKb-y7WRp7ZlD0CsYNdDmXzAry4K1Y0BXFvyo31AP7L2gSRKVcaAobUEALw_wcB&gclsrc=aw.ds">here.</a></h3>
	</div><!--- Footer Section =-->

...
<h2 align="center">TrainerPal Messenger</h2>
</div>
  ...
  <div class='media-body'>
   <img style = 'max-width: 150px' src='uploadedfiles/$profileImage' class='rounded-circle'>
    ...
    <p style = 'font-size:20px;'>$message</p>
     <a class='btn btn-success' href='replyToMessage.php?userID=$userID' role='button'>Reply</a>
     <a class='btn btn-danger' href='trashMessage.php?messageID=$messageID' role='button'>Send to Trash</a>

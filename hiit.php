...
<body>
	...
	<div style="padding-top:20px">
		<h2 align="center">High-Intensity Interval Training</h2>
		<h5 align="center">Here are some brilliant HIIT Drills to improve your fitness.</h5>
	</div><?php

	$selectQuery = "SELECT * FROM TrainerPal_Exercises WHERE workoutType = '4'";

...
<body>
	...
	<font color = 'red'><h3 align='center'>$firstName, please await a response!</h3></font>
	<font color = 'red'><h4 align='center'>You have already sent this trainer a request which they have not yet responded to! <br> Please wait until they respond. Thank you.</h4></font>

	<div align ='center' >
	      <p><a href='trainers.php' class='btn btn-primary'>Back to Trainers</a> <a href='account.php' class='btn btn-primary'>Your Account</a></p>
	      </div>
	</div>
	            </div>";

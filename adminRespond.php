...
<body>
	...
	<section id="accountNav">
		<ul class="nav justify-content-center">
			...
			<li class="nav-item">
				<a class="nav-link" href="adminResolvedIssues.php"><font color="white">Resolved Issues</font></a>
			</li>
		</ul>
	</section>
	<div style="padding-top:20px"></div><?php 
	...
	<h2> Respond to User Issue </h2>
	<h3> Subject: $subject </h3>
	<h4> Message: $message </h4>

	       <form class='subform' id='sendMessageForm' action='processAdminRespond.php?adminMessageID=$adminMessageID' method='POST'>
	                <div class='form-group'>
	                                  <!-- DISPLAYS VALIDATION MESSAGE -->
	                     <font color = 'red'><div class='validation' id='sendMessageVal'></div> </font>
	                    <input class='col-6' type='text' name='sendMessage' id='sendMessage' placeholder = 'Your response...' maxlength='300' required>
	                </div>

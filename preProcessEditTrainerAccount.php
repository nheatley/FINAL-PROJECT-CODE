...
<body>
	...
	<section id="accountNav">
	   ...
	   <div align = 'center' style = 'padding-top:10px'>
	<a class='btn btn-success btn-lg' href='processEditTrainerAddress.php' name = 'gymAddressSubButton' role='button'><font color = 'white'>Yes, this is the one</font></a>
	         </div>
	<div align = 'center' style = 'padding-top:10px'>
	<a class='btn btn-warning btn-lg' href='editTrainerDetails.php' name = 'noButton' role='button'>No, this is wrong.</a>
	         </div>
	   </div>";

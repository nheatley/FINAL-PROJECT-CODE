...
<body>
	...
	<div style="padding-top:20px">
		<h2 align="center">Send Workout to Client</h2>
	</div><!--=== Registration Form ===-->
	<div class="col-8" id="regDiv">
		<!-- SIGN UP FORM -->
		<form action='preProcessSendWorkout.php' class='signUpForm' enctype='multipart/form-data' method='post' onsubmit='return fileValid()'>
			";
			...
			<div class="form-group">
				...
				<div>
					<h4><font color='red'>This youTube video URL does not exist. Please insert a correct URL.</font></h4>
			...
			<input class="button btn-primary u-full-width" id="exercise" name='exerciseButton' type="submit" value="Send">
		</form>
	</div><!--- Footer Section =-->

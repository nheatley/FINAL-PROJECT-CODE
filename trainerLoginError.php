<?php
session_start();
if(isset($_SESSION['carrySession']))  {
...
<div class = "container-fluid">
 ...
 <!------------- LOGIN FORM------------!>
       <div id = "regDiv" class = "col-8">
			<h3 style = "padding-top:10px" id = "loginTitle">Trainer Login</h3>
			<h5> <font color = "red"> You have entered incorrect login credentials! Please try again. </font> </h5>
			<h6> If you don't have any type of account with TrainerPal - click <a href= "register.php">here to register.</a> </h6>
            <!-- SIGN UP FORM -->
            <form class = "loginForm" action="trainerCheck.php" method="post">

	  ...
	  "
	      <div class = 'col-12' style ='border-bottom: gray 3px solid;'>
	       <div align = 'center'>
	          ...
	          <font color = 'green'> <h4 align = 'center'>Below is a record of Invoices from your Trainers.</h4></font>
	      </div>";         
	}
	?>
	<table class='table table-hover'>
		...
		<tbody>
			<tr>
				...
				FROM TrainerPal_User INNER JOIN TrainerPal_Invoices ON TrainerPal_User.userID = TrainerPal_Invoices.owner WHERE TrainerPal_Invoices.client = '$activeID' ORDER BY TrainerPal_Invoices.invoiceID DESC");
				 ...
				 <font color = 'red'> <h2 align='center'>You have no invoices at the moment!</h2></font>
				 </div>";
				 } 

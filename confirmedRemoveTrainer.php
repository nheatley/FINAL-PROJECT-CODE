...
<body>
	...
	<h3 align='center'><font color='red'>You have successfully removed the Trainer.</font></h3>
	<div align='center' style='padding-bottom:10px;'>
		<a class='btn btn-primary' href='trainingHome.php' role='button'>Back to Training Home</a>
	</div>
	<div align='center' style='padding-bottom:10px;'>
		<a class='btn btn-warning' href='trainers.php' role='button'>Search for a new Trainer</a>
	</div><!--- Footer Section =-->

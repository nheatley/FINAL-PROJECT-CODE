...
<body>
	  ...
	  "
	      <div class = 'col-12' style ='border-bottom: gray 3px solid;'>
	          ...
	          <img style = 'max-width: 250px' src='uploadedfiles/$profileImage' class='rounded-circle'>
	           ...
	           <h4 align = 'center' style = 'padding-top:10px'>Here is a record of your Invoices. </h4>
	      </div>";         
	}
	?><?php
	...
	FROM TrainerPal_User INNER JOIN TrainerPal_Invoices ON TrainerPal_User.userID = TrainerPal_Invoices.client WHERE TrainerPal_Invoices.owner = '$activeID' ORDER BY TrainerPal_Invoices.invoiceID DESC");

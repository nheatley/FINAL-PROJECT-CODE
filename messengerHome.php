...
<body>
	...
	<div style="padding-top:20px">
		<h2 align="center">Messenger Home</h2>
	</div><?php 
	      ...
	      "
	          <div class = 'col-12' style ='border-bottom: gray 3px solid;'>
	              ...
	              <font color = 'green'> <h4 align = 'center'> If you need to contact the Admins for any reason, just click below. </h4></font>
	      ...
	      $resultB = $conn->query("SELECT TrainerPal_User.firstName, TrainerPal_User.lastName, TrainerPal_User.userID, TrainerPal_User.profilePictureURL, TrainerPal_MessageHandler.subject, TrainerPal_MessageHandler.messageID, 
	                               ...
	                               AND TrainerPal_MessageHandler.inTrash = '1' ORDER BY TrainerPal_MessageHandler.messageID DESC");
	            if(!$resultB) {
	        echo "did not work";
	        }
	    ...
	    if ($num == 0) {  
	     ...
	     <font color = 'red'> <h2 align='center'>You have no messages at the moment!</h2></font>
	     </div>";
	     }
	      ...
	      <img align = 'center' style = 'max-width: 150px' src='uploadedfiles/$profileImage' class='rounded-circle'>
